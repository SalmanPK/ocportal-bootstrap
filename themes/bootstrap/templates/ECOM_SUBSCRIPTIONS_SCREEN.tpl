...
<div class="wide_table_wrap autosized_table"><table summary="{!COLUMNED_TABLE}" class="table table-bordered table-striped table-results" itemprop="significantLinks">
	<thead>
		<tr>
			<th>
				{!TITLE}
