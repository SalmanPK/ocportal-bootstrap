<div class="fields_set_radio">
	<label class="sr-only" for="choose_{NAME*}">{!USE}: {PRETTY_NAME*}</label>
...
<div class="mini_indent fields_set_contents">
	...
	{+START,IF_NON_EMPTY,{DESCRIPTION}}
		<div class="help-text{+START,IF,{$AND,{$EQ,{$SUBSTR_COUNT,{INPUT}, name="},2},{$EQ,{$SUBSTR_COUNT,{INPUT},type="file"},0},{$EQ,{$SUBSTR_COUNT,{INPUT},type="checkbox"},1}}} field_checkbox_description{+END}">
	...
	<script>		set_up_change_monitor('form_table_field_input__{NAME*}');
	</script>
</div>
