	...
	<div>
		<div class="well well-sm well-permissions_tree_editor_screen"><div class="box_inner">
			...
			<div class="pte_tree">
				...
				<script>					var site_tree=new tree_list('tree_list','data/site_tree.php?start_links=1&get_perms=1{$KEEP;}','','',true);
	...
	<div class="well well-sm well-permissions_tree_editor_screen"><div class="box_inner">
		...
		<form title="{!PRIMARY_PAGE_FORM}" method="post" action="index.php">
			<div class="clearfix">
				...
				<p class="pull-right" id="selection_message">
					<em>{!PERMISSIONS_TREE_EDITOR_NONE_SELECTED}</em>
				</p>
				<div>
					<input type="button" class="btn btn-primary btn-page" id="selection_button" disabled="disabled" value="{!SET}" onclick="set_permissions(document.getElementById('tree_list'));" />
				</div>
			</div>
		</form>
	</div></div>
