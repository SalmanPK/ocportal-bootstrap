...
<div class="sr-only"><label for="{STUB%}_day">{!DAY}</label></div>
<select onchange="if (typeof window.match_calendar_from_to!='undefined') match_calendar_from_to('{STUB%}');" {+START,IF_PASSED,TABINDEX}tabindex="{TABINDEX*}" {+END}id="{STUB%}_day" name="{STUB%}_day" class="form-control form-control-inline{+START,IF,{$NOT,{NULL_OK}}} input_list_required date{+END}">
	<option value="">-</option>
	{DAYS}
</select>


<div class="sr-only"><label for="{STUB%}_month">{!MONTH}</label></div>
<select onchange="if (typeof window.match_calendar_from_to!='undefined') match_calendar_from_to('{STUB%}');" {+START,IF_PASSED,TABINDEX}tabindex="{TABINDEX*}" {+END}id="{STUB%}_month" name="{STUB%}_month" class="form-control form-control-inline{+START,IF,{$NOT,{NULL_OK}}} input_list_required date{+END}">
	<option value="">-</option>
	{MONTHS}
</select>


<div class="sr-only"><label for="{STUB%}_year">{!YEAR}</label></div>
<select onchange="if (typeof window.match_calendar_from_to!='undefined') match_calendar_from_to('{STUB%}');" {+START,IF_PASSED,TABINDEX}tabindex="{TABINDEX*}" {+END}id="{STUB%}_year" name="{STUB%}_year" class="form-control form-control-inline{+START,IF,{$NOT,{NULL_OK}}} input_list_required date{+END}">
	<option value="">-</option>
	{YEARS}
</select>
...
<script>	var mindate=null,maxdate=null;
