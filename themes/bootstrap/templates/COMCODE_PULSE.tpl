...
{$REQUIRE_JAVASCRIPT,javascript_pulse}<span class="pulse_wave" id="pulse_wave_{$GET,RAND_ID_PULSE}">{CONTENT}</span><script>	add_event_listener_abstract(window,'load',function () {
