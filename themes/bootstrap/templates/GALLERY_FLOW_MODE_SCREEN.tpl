	...
	{+START,IF_NON_EMPTY,{ENTRIES}}
		<div class="well well-sm well-gallery_flow_mode_screen__other"><div class="box_inner">
			...
			<p class="gallery_start_slideshow">
				<span class="associated-link"><a target="_blank" title="{!_SLIDESHOW}: {!LINK_NEW_WINDOW}" href="{$PAGE_LINK*,_SELF:galleries:{FIRST_ENTRY_ID*}:slideshow=1:wide_high=1}">{!_SLIDESHOW}</a></span>
			</p>
