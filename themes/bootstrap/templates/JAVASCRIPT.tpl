...
function select_tab(id,tab)
{
	...
	for (i=0;i<element.parentNode.parentNode.children.length;i++)
	{
		if (element.parentNode.parentNode.children[i].children[0].id && (element.parentNode.parentNode.children[i].children[0].id.substr(0,2)=='t_')) {
			tabs.push(element.parentNode.parentNode.children[i].children[0].id.substr(2));
		}
	}
	...
	for (i=0;i<tabs.length;i++)
	{
		...
		if (element)
		{
			...
			if (tabs[i]==tab)	element.parentNode.className+=' active';
		}
	}
