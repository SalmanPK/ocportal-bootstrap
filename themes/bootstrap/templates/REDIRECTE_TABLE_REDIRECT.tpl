<tr>
	<td>
		<div class="sr-only"><label for="from_zone_{I*}">{!REDIRECT_FROM_ZONE}</label></div>
	...
	<td>
		<div class="sr-only"><label for="from_page_{I*}">{!REDIRECT_FROM_PAGE}</label></div>
		<input maxlength="80" class="quite_wide_field" type="text" id="from_page_{I*}" name="from_page_{I*}" value="{FROM_PAGE*}" />
		&rarr;
	</td>
	<td>
		<div class="sr-only"><label for="to_zone_{I*}">{!REDIRECT_TO_ZONE}</label></div>
	...
	<td>
		<div class="sr-only"><label for="to_page_{I*}">{!REDIRECT_TO_PAGE}</label></div>
		<input maxlength="80" class="quite_wide_field" type="text" id="to_page_{I*}" name="to_page_{I*}" value="{TO_PAGE*}" />
	</td>
	<td>
		<div class="sr-only"><label for="is_transparent_{I*}">{!IS_TRANSPARENT_REDIRECT}</label></div>
