...
{+START,IF_NON_EMPTY,{INTERESTED}}
	<div class="clearfix zebra_{$CYCLE%,zebedee,0,1}" onclick="/*Access-note: code has other activation*/ var e=document.getElementById('{S;*}int_{TYPE_ID;*}'); e.checked=!e.checked;">
