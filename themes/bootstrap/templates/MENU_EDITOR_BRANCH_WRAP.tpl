<div class="menu_editor_branch" id="branch_wrap_{I*}">
	<div id="branch_{I*}">
		...
		<div class="sr-only"><label id="label_branch_type_{I*}" for="branch_type_{I*}">{!MENU_ENTRY_BRANCH}</label></div>
	...
	<script>		document.getElementById('new_window_{I%}').value='{NEW_WINDOW%}';
