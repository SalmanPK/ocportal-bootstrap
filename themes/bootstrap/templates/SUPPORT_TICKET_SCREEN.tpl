	...
	{+START,IF,{NEW}}
		...
		{+START,SET,EXTRA_COMMENTS_FIELDS_1}
			<tr>
				...
				<td>
					<select id="ticket_type" name="ticket_type" class="form-control input_list_required wide_field">
						<option value="">---</option>
						{+START,LOOP,TYPES}
					...
					<div id="error_ticket_type" style="display: none" class="alert alert-danger alert-input-error"></div>
				</td>
			</tr>
		{+END}
	{+END}
