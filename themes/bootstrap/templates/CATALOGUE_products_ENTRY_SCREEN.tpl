<div itemscope="itemscope" itemtype="http://schema.org/Offer" class="product_view">
	...
	<div class="well well-sm well-catalogue_products_entry_screen"><div class="box_inner">
		<div class="hproduct"{$?,{$MATCH_KEY_MATCH,_WILD:_WILD:misc}, itemscope="itemscope" itemtype="http://schema.org/Offer"}>
			...
			{+START,IF_NON_EMPTY,{$TRIM,{FIELDS}}}
				<div class="table-wrap">
					<table id="product-attribute-specs-table" class="table table-bordered table-striped table-results" summary="{!MAP_TABLE}">
						{+START,IF,{$NOT,{$MOBILE}}}
							<colgroup>
