<div>
	...
	{+END}
			...
			{+START,IF,{$NOT,{SIMPLE_STYLE}}}
				<div class="various_ticks clearfix">
				{+START,LOOP,OUT}
			...
			{+START,IF_PASSED,CUSTOM_NAME}
				<div class="various_ticks clearfix">
					<div class="input_other_tick">
						...
						<label for="{CUSTOM_NAME*}">{!OTHER}</label> <label for="{CUSTOM_NAME*}_value"><span class="help-text">({!PLEASE_STATE})</span></label>
					...
					<script>						document.getElementById('{CUSTOM_NAME%}_value').onchange();
					</script>
				</div>
			{+END}
