...
<div class="wiki_screen">
	{+START,IF_NON_EMPTY,{DESCRIPTION}}
		{+START,IF,{$NOT,{HIDE_POSTS}}}
			<div class="pe_wiki_page_description" itemprop="description">
				<div class="well well-sm well-wiki_page_screen"><div class="box_inner">
	...
	{+START,IF_NON_EMPTY,{POSTS}}
		<div class="ocf-topic wiki-table">
			{POSTS}
		</div>
			...
			<form title="{!MERGE_CEDI_POSTS}" action="{$PAGE_LINK*,_SEARCH:cedi:type=mg:id={ID},1}" method="post">
				<div class="clearfix">
					<div class="wiki_merge_posts_button">
						<input onclick="if (add_form_marked_posts(this.form,'mark_')) { disable_button_just_clicked(this); return true; } window.fauxmodal_alert('{!NOTHING_SELECTED=;}'); return false;" class="btn btn-primary btn-page" type="submit" value="{!MERGE_CEDI_POSTS}" />
					</div>
				</div>
			</form>
		{+END}
