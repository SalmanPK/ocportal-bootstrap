				...
				<td>
					...
					{+START,IF,{$HAS_ACTUAL_PAGE_ACCESS,admin_invoices}}
						<ul class="list-inline">
							<li><a title="{!DELETE}: #{ID}" href="{$PAGE_LINK*,adminzone:admin_invoices:type=delete:id={ID}}"><img class="btn btn-primary btn-pageitem" src="{$IMG*,pageitem/delete}" alt="{!DELETE}" title="{!DELETE}" /></a></li>
