...
<div class="clearfix" id="ze_panels_wrap">
...
<form title="{!SAVE}" action="{URL*}" method="post" target="_self">
	...
	<p class="proceed_button vertical_alignment">
		<input class="btn btn-primary btn-page" type="button" value="{!SAVE}" onclick="fetch_more_fields(); this.form.submit();" /> <span class="help-text">{!ZE_CLICK_TO_EDIT}</span>
	</p>
</form>
