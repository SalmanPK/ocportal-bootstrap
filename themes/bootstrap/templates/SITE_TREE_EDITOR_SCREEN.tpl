...
<div class="clearfix">
	...
	<div class="site_tree_left">
		<div class="box box___site_tree_editor_screen"><div class="box_inner">
			...
			<script>				var site_tree=new tree_list('tree_list','data/site_tree.php?start_links=1&get_perms=0{$KEEP;}','','',false,null,true);

				var actions_tpl='{!ACTIONS;}:<ul role="navigation" class="list-actions">[1]<\/ul>';
				var actions_tpl_item='<li><a href="[2]">[1]<\/a><\/li>';

				var info_tpl='<div class="table-wrap"><table class="table table-bordered table-striped table-results" summary="{!MAP_TABLE;}"><tbody>[1]<\/tbody><\/table><\/div>';
