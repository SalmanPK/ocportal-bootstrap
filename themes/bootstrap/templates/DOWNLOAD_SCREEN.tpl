	...
	<div class="clearfix">
		<div class="download_meta_data">
				...
				<div class="well well-sm well-download_screen">
					...
					{+END}
						<div class="download_now" itemprop="significantLinks">
							<p class="download_link associated-link suggested_link"><a rel="nofollow" href="{$FIND_SCRIPT*,dload}?id={ID*}{$KEEP*,0,1}{+START,IF,{$EQ,{$CONFIG_OPTION,anti_leech},1}}&amp;for_session={$SESSION_HASHED*}{+END}"><strong>{!DOWNLOAD_NOW}</strong></a></p>
			...
			<div class="download_stats_wrapper">
				<div class="table-wrap"><table summary="{!MAP_TABLE}" class="table table-bordered table-striped table-results table-download-stats" role="contentinfo">
					{+START,IF,{$NOT,{$MOBILE}}}
						<colgroup>
