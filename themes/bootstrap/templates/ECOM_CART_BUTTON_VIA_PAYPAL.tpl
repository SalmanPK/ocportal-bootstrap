<form title="{!MAKE_PAYMENT}" class="pull-right" action="{IPN_URL*}" method="post">
	...
	<p class="purchase_button">
		<input class="btn btn-primary btn-page" type="image" src="{$IMG*,page/cart_checkout}" name="submit" alt="{!PROCEED}" title="{!PROCEED}" />
	</p>	
</form>
