<form title="{!MAKE_PAYMENT}" class="pull-left" action="{IPN_URL*}" method="post">
	...
	<div class="purchase_button">
		<input style="border: 0px" class="btn btn-primary btn-page" type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but23.gif" name="submit" alt="Make payments with PayPal - it's fast, free and secure!" />
	</div>
</form>
