...
<script src="{$BASE_URL*}/themes/{$THEME}/bower_components/jquery/dist/jquery.js"></script>
<script src="{$BASE_URL*}/themes/{$THEME}/bower_components/bootstrap/dist/js/bootstrap.js"></script>
